              ...
              <tbody>
                <tr 
                  ...
                  <td class="px-6 py-5">
                    <div class="flex items-center space-x-3">
                      <div class="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center">
                        <span class="text-green-700 font-semibold">{{ item.tanggal.charAt(0) }}</span>
                      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div class="transform hover:scale-105 transition-transform duration-300">
            ...
            <div class="flex space-x-4">
              <a href="#" class="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-black transition-all duration-300 transform hover:scale-125 hover:rotate-12">
                <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                </svg>
              </a>
              
              <a href="#" class="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-pink-600 transition-all duration-300 transform hover:scale-125">
                <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" class="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-green-500 transition-all duration-300 transform hover:scale-125 hover:-rotate-12">
                <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
...
const tableData3 = ref([
  {
    ...
    peserta: 'Supri Supriyadi, Ahmad Mubarok, Supriyanto'
  },
  {
    no: 2,
